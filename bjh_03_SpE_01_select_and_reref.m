function [ALLEEG_SpE_select_and_reref] = bjh_03_SpE_01_select_and_reref(MAINPATH,CONFIGPATH)
...
% 
% input:    MAINPATH:   [string] path where .set files are stored
...
for s = 1:size(subj_info,1)
    ...
    ALLEEG_SpE_select_and_reref(s) = EEG;
    clear EEG;
