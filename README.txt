This folder contains the analysis pipeline for the manuscript "Ear-EEG Measures of Auditory Attention to Continuous Speech".

The corresponding dataset can be found in the OpenNeuro repository ...

To replicate the analysis use MATLAB R2019b and follow these steps:

1) Download all scripts into one folder.
2) Download the BIDS dataset from ... into a folder that is on the same level as the folder containing the scripts. 
